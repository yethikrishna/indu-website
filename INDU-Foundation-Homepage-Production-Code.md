# INDU Foundation — Homepage Production Code

## File: `src/routes/+page.svelte`

> Complete cinematic SvelteKit 5 homepage. Three.js aurora icosahedron, GSAP ScrollTrigger, particle system, animated preloader.
...
<script lang="ts">
  ...
  let preloaderCanvasEl: HTMLCanvasElement;
  ...
  function initScrollObservers() {
    ...
    const navObserver = new IntersectionObserver(
      ([entry]) => { navFrosted = !entry.isIntersecting; },
...
<!-- ═══════════════════════════════════════════════ NAVIGATION -->
<nav class="nav" class:frosted={navFrosted}>
  <div class="nav-inner">
    <a href="/" class="nav-logo">
      <svg viewBox="0 0 40 40" width="36" height="36">
        <circle cx="20" cy="20" r="18" fill="none" stroke="#E8A838" stroke-width="2"/>
        <path d="M12 20 Q20 8 28 20 Q20 32 12 20" fill="none" stroke="#4ECDC4" stroke-width="2"/>
      </svg>
      <span>INDU</span>
    </a>
    ...
    <div class="nav-actions">
      <a href="https://github.com/indu-lang/indu" class="nav-github" target="_blank" rel="noreferrer">
      ...
      <a href="/docs/getting-started/installation" class="btn-primary-sm">Get Started</a>
    </div>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-github { color: var(--text-muted); transition: color 0.2s; }
  .nav-github:hover { color: var(--gold); }
  .btn-primary-sm {
    padding: 8px 20px; background: var(--gold); color: var(--primary);
